...
Structured-CFG merge, continue, and phi repair owns to the separately measured
`passes/cfg_repair/` subsystem. Final entry construction owns to `passes/finalize.rs`, with
dead-global/debug and capability closure in `passes/module_cleanup.rs`.
